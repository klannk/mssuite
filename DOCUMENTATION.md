...
```python
labelsForLMM = ['Annotated Sequence','Master Protein Accessions','Abundance:']
```
...
```python
processor(self,list_of_df,function,*args,**kwargs)
```
...
```python
get_channels(self, input_file, custom=None)
```
